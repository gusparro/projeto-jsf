...
INSERT INTO product (name, description, price, created_at) values ('Smartphone Motorola Moto G51 5G 128GB Android 11 Tela 6.8 Azul', 'Ficha técnica Fabricante Motorola tela Tamanho 6,8 polegadas Resolução 1080 x 2400 pixels Tecnologia ips.',  1.488.90, now());
